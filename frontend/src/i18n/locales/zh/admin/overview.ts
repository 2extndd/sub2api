export default {
    ...
    users: {
      ...
      accountDenialsAction: '上游账号排除',
      accountDenialsTitle: '上游账号排除',
      accountDenialsHint: '选中的账号不会为此用户提供服务。未选择任何账号时，当前及未来新增的所有账号默认可用。',
      accountDenialsSearch: '按账号 ID、名称、平台或类型搜索',
      accountDenialsSelectedOnly: '仅显示已选择',
      accountDenialsCount: '已排除 {count} 个账号',
      accountDenialsDefaultAllow: '无限制 — 新增上游账号将自动可用。',
      accountDenialsApplied: '所有未选择的账号仍然可用。',
      accountDenialsEmpty: '没有匹配的账号',
      accountDenialsPriority: '优先级 {value}',
      accountDenialsExcluded: '已排除',
      accountDenialsLoadError: '加载上游账号排除列表失败',
      accountDenialsSaveError: '保存上游账号排除列表失败',
      accountDenialsConflict: '其他管理员已修改此排除列表，已重新加载最新版本。',
      accountDenialsSaved: '上游账号排除列表已保存',
      replaceGroup: '替换分组',
