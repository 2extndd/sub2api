export default {
    ...
    users: {
      ...
      accountDenialsAction: 'Upstream account exclusions',
      accountDenialsTitle: 'Upstream Account Exclusions',
      accountDenialsHint: 'Selected accounts will never serve this user. If none are selected, every current and future account remains available by default.',
      accountDenialsSearch: 'Search by account ID, name, platform, or type',
      accountDenialsSelectedOnly: 'Selected only',
      accountDenialsCount: '{count} accounts excluded',
      accountDenialsDefaultAllow: 'No restrictions — new upstream accounts are automatically available.',
      accountDenialsApplied: 'All non-selected accounts remain available.',
      accountDenialsEmpty: 'No matching accounts',
      accountDenialsPriority: 'Priority {value}',
      accountDenialsExcluded: 'Excluded',
      accountDenialsLoadError: 'Failed to load upstream account exclusions',
      accountDenialsSaveError: 'Failed to save upstream account exclusions',
      accountDenialsConflict: 'These exclusions changed in another admin session. The latest version has been reloaded.',
      accountDenialsSaved: 'Upstream account exclusions saved',
