...
const apiKeyAuthSnapshotVersion = 24 // v19: user deny-list; v22: group free_openai_fast; v24: group model_allowlist (enforced)
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	snapshot := &APIKeyAuthSnapshot{
		...
		DeniedAccountIDs: apiKey.DeniedAccountIDs,
		Quota:            apiKey.Quota,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	apiKey := &APIKey{
		...
		DeniedAccountIDs: snapshot.DeniedAccountIDs,
