export default {
    accounts: {
      ...
      denyingUsersAction: 'View users excluding this account',
      denyingUsersShort: 'Exclusions',
      denyingUsersTitle: 'User Exclusions',
      denyingUsersHint: 'Read-only view of users whose upstream deny-list contains this account.',
      denyingUsersEmpty: 'No users explicitly exclude this account.',
      denyingUsersLoadError: 'Failed to load users excluding this account',
      dataActions: 'Data',
      toolActions: 'Tools',
      viewColumns: 'Columns',
      ...
      columns: {
        ...
        notes: 'Notes',
        priority: 'Priority',
        billingRateMultiplier: 'Account Cost Rate',
        usageBillingMultiplier: 'Customer Billing Rate',
      ...
      openai: {
        ...
        endpointCapabilitiesDesc:
          'Used by account routing. The text endpoint follows the Responses API support setting above and is shown as Responses, Chat Completions, or auto mode; Embeddings independently controls /v1/embeddings; Image Generation controls /v1/images.',
        ...
        imageGenerationOnly: 'Image generation only',
        imageGenerationOnlyDesc: 'Enable image generation endpoint only; other endpoints will be disabled. Responses mode is not applicable for image-only accounts.',
        responsesStatusAutoSupported: 'Auto probe: Responses',
        responsesStatusAutoUnsupported: 'Auto probe: Chat Completions',
        responsesModeTextDisabledHint: 'Not applicable for image-only accounts. Enable text generation (Chat Completions or Responses) to configure response mode.',
      ...
      billingRateMultiplierHint: 'Provider-cost and margin accounting only; does not change customer debit',
      usageBillingMultiplier: 'Customer Usage Billing Multiplier',
      usageBillingMultiplierHint: 'Applied once after this routing account succeeds; 1 keeps official customer pricing',
      usageBillingMultiplierInvalid: 'Customer usage billing multiplier must be finite, greater than 0, and at most 1,000,000',
      expiresAt: 'Expires At',
